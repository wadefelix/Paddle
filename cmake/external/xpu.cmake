...
if(NOT XPU_SDK_ROOT)
  if (WITH_AARCH64)
      SET(XPU_URL    "../../../../../paddle-external-deps/aarch64.xpu_2021_01_13.tar.gz" CACHE STRING "" FORCE)
  elseif(WITH_SUNWAY)
      SET(XPU_URL    "../../../../../paddle-external-deps/sunway.xpu_2021_01_13.tar.gz" CACHE STRING "" FORCE)
  else()
      SET(XPU_URL    "../../../../../paddle-external-deps/xpu_2021_05_19.tar.gz" CACHE STRING "" FORCE)
  endif()
